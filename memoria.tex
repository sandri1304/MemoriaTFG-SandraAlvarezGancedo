...
\begin{figure}[H]
	  \centering
	  \includegraphics[width=5cm, keepaspectratio]{img/ordenadoProductos.png}
...
\begin{figure}[H]
	  \centering
	  \includegraphics[width=3.5cm, keepaspectratio]{img/filtros.png}
	  \caption{Filtros.}
	  \label{fig:filtros}
\end{figure}
