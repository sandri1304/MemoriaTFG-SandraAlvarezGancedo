...
\begin{figure}[H]
 \centering
 \subfloat{
    \includegraphics[width=0.25\textwidth]{img/resumenPagosCliente.png}}
  \subfloat{
    \includegraphics[width=0.25\textwidth]{img/inicioSesionPaypal.png}}
