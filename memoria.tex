...
\begin{figure}[H]
	  \centering
	  \includegraphics[width=15cm, keepaspectratio]{img/homePaginaPrincipal.png}
...
\begin{figure}[H]
	  \centering
	  \includegraphics[width=15cm, keepaspectratio]{img/subcategorias.png}
...
\begin{figure}[H]
	  \centering
	  \includegraphics[width=15cm, keepaspectratio]{img/listadoProductosSubcategoria.png}
	  \caption{Subcategorías.}
	  \label{fig:subcategorias}
\end{figure}
