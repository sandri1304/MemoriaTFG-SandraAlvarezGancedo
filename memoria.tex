...
Bcrypt permite realizar comparaciones entre diferentes valores, pero para realizar la comparación no lo hace como otros sistemas de cifrado donde se descifra el dato a comparar, sino que lo que hace en cifrar con el salt el valor que se quiere comparar. 
...
\begin{itemize}
	\item Tiene numerosas estrategias de autenticación. Por ejemplo, permite autenticarse utilizando bases de datos en las que se almacenan las sesiones o puede autenticarse el inicio de sesión único de OpenID y OAuth, usados por ejemplo en Facebook. 
